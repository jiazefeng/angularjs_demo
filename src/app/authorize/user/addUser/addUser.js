angular.module('robot.addUser', [
        ...
        $stateProvider.state('home.addUser', {
            ...
            views:{
                'content':{
                    ...
                    templateUrl: 'authorize/user/addUser/addUser.tpl.html',
                    resolve:{
                        roleInfoData:['$http','$stateParams',function($http){
                            return $http.get('/role/searchRoleInfo')
                        }]
                    }
                }
            }
    ...
    .controller('addUserController', ['$modal','$scope', '$http','roleInfoData','$state','$filter','ApiBaseUrl',
