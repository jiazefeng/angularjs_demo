angular.module('robot.updateUser', [
...
.config(['$stateProvider', function ($stateProvider) {
    $stateProvider.state('home.updateUser', {
        ...
        views: {
            'content': {
                ...
                templateUrl: 'authorize/user/updateUser/updateUser.tpl.html',
                resolve: {
...
.controller('updateUserController', ['$modal','$scope', '$http', 'userInfoData', '$filter', '$stateParams', '$state', 'ApiBaseUrl',
