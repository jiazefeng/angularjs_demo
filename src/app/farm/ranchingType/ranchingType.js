angular.module('robot.ranchingType', [
    'robot.ranchingType.mock',
    'ui.router'
])

    .config(['$stateProvider', function ($stateProvider) {
        $stateProvider.state('home.ranchingType', {
            url: '/ranchingType',
            bookname: '畜牧种类列表',
            parentsname: '农场管理',
            views: {
                'content': {
                    controller: 'ranchingTypeController',
                    templateUrl: 'farm/ranchingType/ranchingType.tpl.html',
                    resolve: {
                        ranchingTypeListData: ['$http', function ($http) {
                            return $http.get('/ranchingType/searchRanchingTypeList')
                        }]
                    },
                },
            }
    ...
    .controller('ranchingTypeController', ['$scope', '$http', 'ranchingTypeListData', '$modal', '$uibModal',
        function ($scope, $http, ranchingTypeListData, $modal, $uibModal) {
            $scope.data = ranchingTypeListData.data;
